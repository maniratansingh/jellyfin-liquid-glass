...
1. Copy all the CSS files in this folder to a directory accessible by your Jellyfin server, or host them on a CDN.
2. In Jellyfin, navigate to **Dashboard -> General -> Custom CSS code**.
3. Import the main file:
   ```css
   @import url('path/to/liquid-glass.css');
   ```
